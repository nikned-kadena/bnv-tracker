#!/usr/bin/env python3
"""
BnV Tracker v4.14 — ScraperAPI premium, prodaja + izdavanje
"""
...
def save_snapshot(mode, all_listings, total_raw):
    ...
    # Overwrite ako već postoji entry za danas, inače dodaj
...
def main():
    print("="*55)
    print(f"BnV Scraper v4.14 — {datetime.now().strftime('%Y-%m-%d %H:%M UTC')}")
