#!/usr/bin/env python3
"""
BnV Tracker v4.12 — ScraperAPI premium, prodaja + izdavanje
"""
...
def scraper_get(url, render_js=False):
    params = {
        ...
        "premium":      "true",   # premium proxy — zaobilazi 403 blokade
        "keep_headers": "true",
    }
    try:
...
def main():
    print("="*55)
    print(f"BnV Scraper v4.12 — {datetime.now().strftime('%Y-%m-%d %H:%M UTC')}")
