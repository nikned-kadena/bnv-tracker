...
export default function Dashboard() {
  ...
  const [selBlds, setSelBlds] = useState(new Set());
  ...
  const diffSummary = useMemo(()=>{
    ...
    return {
      newCount:     (diff.new??[]).filter(l=>selBlds.has(l.zgrada)).length,
      removedCount: (diff.removed??[]).filter(l=>selBlds.has(l.zgrada)).length,
    };
  },[diff,selBlds]);
            ...
            <div style={{overflowX:"auto"}}>
              <table style={{width:"100%",borderCollapse:"collapse",fontSize:13,tableLayout:"fixed"}}>
                <thead style={{background:"#F9FAFB"}}>
                  <tr style={{borderBottom:`1px solid ${C.border}`}}>
                    <SortTH label="Zgrada" sortKey="zgrada" activeSortKey={sortKey} sortDir={sortDir} onSort={toggleSort} width="28%"/>
                    <SortTH label="Tip"    sortKey="str"    activeSortKey={sortKey} sortDir={sortDir} onSort={toggleSort} width="14%"/>
                    <SortTH label="m²"     sortKey="m2"     activeSortKey={sortKey} sortDir={sortDir} onSort={toggleSort} width="8%"  align="right"/>
                    <SortTH label="Cena"   sortKey="cena"   activeSortKey={sortKey} sortDir={sortDir} onSort={toggleSort} width="16%" align="right"/>
                    {mode==="prodaja"&&<SortTH label="€/m²" sortKey="m2p" activeSortKey={sortKey} sortDir={sortDir} onSort={toggleSort} width="12%" align="right"/>}
